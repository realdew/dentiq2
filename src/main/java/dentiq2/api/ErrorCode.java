...
//	;
	...
	USER_011("USER_011", "등록되지 않은 Email 주소입니다."),		// 임시 비밀번호 발급 전 단계에서 해당 email 주소가 없는 경우.
	USER_012("USER_012", "비밀번호 변경에 실패했습니다. 고객센터로 문의하여 주십시오."),	// 비밀번호 변경 실패
	
		
	AUTH_901("AUTH_901", "로그인되어 있지 않습니다."),				// 로그인되어 있지 않습니다.
	AUTH_902("AUTH_902", "사용시간이 만료되었습니다. 다시 로그인해 주세요."),	// expireTimeAt 초과의 경우
	AUTH_911("AUTH_911", "요청된 이메일주소가 세션의 정보와 일치하지 않습니다."),	// 비밀번호 변경에서 입력된 email과 세션의 email이 불일치하는 경우
	...
	USER_602("USER_602", "공고에 지원을 위해서는 이력서를 먼저 작성하여야 합니다."),	// 공고지원하려고 할 때, 이력서가 아직 작성되어 있지 않는 경우
